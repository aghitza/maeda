...
\begin{theorem}[Frobenius]
  ...
  Let $\deg F=d_1+\ldots+d_t$ be a partition of $\deg F$.  
...
\begin{lemma}
  Let $d=d_1+\ldots+d_t$ be a partition of the positive integer $d$.  The
  number of elements of $\SS_d$ of cycle type $d_1,\ldots,d_t$ is equal to
  \begin{equation*}
    C(d_1,\ldots,d_t)=\frac{d!}{d_1\cdots d_t}.
  \end{equation*}
\end{lemma}
\begin{proof}
  TODO
