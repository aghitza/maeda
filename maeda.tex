...
\begin{proof}
  ...
  Note that the odd factorials above can be expanded as follows:
  \begin{eqnarray*}
    (d-3)!!=\frac{(d-3)!}{2^{d/2-2}(d/2-2)!}\\
    (d-4)!!=\frac{(d-4)!}{2^{(d-5)/2}(\frac{d-5}{2})!}
  \end{eqnarray*}
  We now obtain the inequality given in the statement as follows:
  \begin{eqnarray*}
    D_{II}(d)&=&\begin{cases}
                  \left[\frac{(d-3)!}{(d/2-2)!}\right]^2\frac{1}{2^{d-4}\frac{1}{2(d-2)!}\\
                  \left[\frac{(d-4)!}{(\frac{d-5}{2})!}\right]^2\frac{1}{2^{d-5}\frac{d-2}{2(d-2)!}\\
                 \end{cases}
             &=&
  \end{eqnarray*}
\end{proof}
