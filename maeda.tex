...
definitions and properties of modular forms.  For a thorough exposition that
covers most of the background needed in this paper, the reader is 
invited to consult~\cite{Stein}.
...
number of cases that the Galois group of $F$ is the full symmetric group
...
operators $T_n$.  We state three such results, having slightly different
flavors.  
...
I, II and III.  We start with a well-known result
(see, for instance, Proposition 1.3.2 of~\cite{Stanley1}).
...
For completeness, here is the density of primes of type IV, as defined in
...
\end{proposition}
\begin{proof}
  Primes of type II correspond to elements of $\SS_d$ containing a 1-cycle and
  a $(d-1)$-cycle. Applying Lemma~\ref{lem:cycletype}, we see
  \begin{equation*}
    C(d)=\frac{d!}{d-1}=d(d-2)!
  \end{equation*}
  Thus, by Theorem~\ref{thm:frobenius}, the density of primes of type IV is
  \begin{equation*}
    \frac{d(d-2)!}{d!}=\frac{d(d-2)!}{d(d-1)(d-2)!}=\frac{1}{d-1}.
  \end{equation*}
\end{proof}
