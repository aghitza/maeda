...
Parkville, Australia}
\email{aghitza@alum.mit.edu, mcandrew@student.unimelb.edu.au}
...
\metadata{11F25}{11F11, 11-04}{Modular forms, Hecke operators, Sage}
...
required testing \numprint{655} primes, and each test took about 47 seconds.
...
\newblock {\em J. Number Theory}, 57(1):130--132, 1996.

\bibitem{ConreyFarmer}
...
\newblock {\em Math. Comp.}, 71(239):1263--1270 (electronic), 2002.
...
\newblock {\em Int. J. Number Theory}, 7(5):1247--1253, 2011.
...
\newblock {\em Pacific J. Math.}, (Special Issue):189--217, 1997.
...
\newblock {\em Chinese J. Math.}, 23(4):329--342, 1995.

\bibitem{Lim}
Chu-Wee Lim.
\newblock {\em Decomposition of spaces of cusp forms over {Q}, and variants of
  partial {N}im}.
...
\newblock {\em Amer. Math. Monthly}, 62:26--29, 1955.
...
\newblock {\em {S}age {M}athematics {S}oftware ({V}ersion 5.0)}.
\newblock The Sage Development Team, 2012.

\bibitem{StevenhagenLenstra}
P.~Stevenhagen and H.~W. Lenstra, Jr.
\newblock Chebotar\"ev and his density theorem.
\newblock {\em Math. Intelligencer}, 18(2):26--37, 1996.
